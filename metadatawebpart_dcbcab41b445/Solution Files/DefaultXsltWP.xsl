...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
  ...
  <xsl:template name="listIdTemplate" >
    <!--GetlistId-->
  </xsl:template>
  <xsl:template name="terms" >
    ...
    <xsl:template name="termtemplate">
        <xsl:element name="div">
            ...
            <a>
				<xsl:attribute name="href">/_layouts/Categories.aspx?FieldName=Wiki_x0020_Page_x0020_Categories&amp;ListId=c3f60195-0fdc-4253-9b0d-f342476a5e0a&amp;FieldValue=<xsl:value-of select="termID"/></xsl:attribute>
